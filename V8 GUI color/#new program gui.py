...
def save_to_file(distance_x_cm, distance_y_cm, c=""):
    with open("E:\My FakRizz StudiO\Download07\V8 GUI\log.txt", "a") as file:
            ...
            for index, row in px.iterrows():
                ...
                if center_x != precenter_x or center_y != precenter_y:
                    ...
                    if is_inside_square(center_x, center_y):
                        ...
                        data.append([round(distance_x_cm, 2), round(distance_y_cm, 2)])
                        if len(data) > len(px):
                            data.pop()
...
def start_detection_auto():
    ...
    while is_detecting:
            ...
            for index, row in px.iterrows():
                ...
                if center_x != precenter_x or center_y != precenter_y:
                    ...
                    if is_inside_square(center_x, center_y):
                        ...
                        new_data = [round(distance_x_cm, 2), round(distance_y_cm, 2)]
        ...
        if count % (20 * 5) == 0:  # Every 20 seconds (since detection is done every 5 frames)
            send_data()
